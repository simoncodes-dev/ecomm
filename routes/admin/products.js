...
router.post('/admin/products/new', requireAuth, upload.single('image'), [requireProductTitle, requireProductPrice],
...
router.post('/admin/products/:id/edit', requireAuth, 
    upload.single('image'), [requireProductTitle, requireProductPrice],
